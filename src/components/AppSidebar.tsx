...
export function AppSidebar() {
  ...
  // Mobile usa MobileTabBar (renderizado pelo AppLayout); a sidebar é só desktop.
  if (isMobile) return null;

  // Desktop: fixed sidebar
  return (
    <aside className="glass-nav fixed left-0 top-0 z-40 flex h-screen w-64 flex-col">
      {sidebarContent}
    </aside>
  );
}
